...
https://github.com/Syrah0/CC5114-Redes_Neuronales/tree/master/MiniTarea3
...
3.- Buscar la carpeta o archivo que se desea ejecutar (es recomendable seleccionar la carpeta que contiene el archivo y hacer click en "OK", en caso contrario seleccionar el archivo Sigmoid.py y luego "OK")

4.- Una vez abierto el archivo seleccionado hacer click derecho sobre el nombre del archivo (o en el archivo como tal) y seleccionar "Run 'Sigmoid.py'".
...
Tras lo anterior aparecerán los gráficos tras el entrenamiento del sigmoid neuron.
...
from <Nombre/Carpeta/Archivo>.Sigmoid import *

Por ejemplo, si Sigmoid.py está de Tarea entonces poner: from Tarea.Sigmoid import *
...
p2 = Sigmoid(w1,w2,bias,threshold)
p2.sigmoid(x1,x2)
